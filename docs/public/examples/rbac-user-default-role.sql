...
BEGIN
    ...
    INSERT INTO "permission".casbin_rule (ptype, v0, v1, v2, v3, v4, v5, v6) VALUES('p', 'role:default/devportal-user', 'cluster.explorer.permission.environment.read', 'read', 'allow', NULL, NULL, NULL);
