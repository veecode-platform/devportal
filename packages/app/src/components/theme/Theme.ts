...
/* const lightThemeOptions = createBaseThemeOptions({
  palette: {
    // ...themes.light,
    primary: {
      main: '#202020',
...
const darkThemeOptions = createBaseThemeOptions({
  palette: {
    // ...themes.dark,
    primary: {
      main: '#ffffffb3',
...
export const devportalThemes = {
  light: createUnifiedTheme(lightThemeOptions),
  dark: createUnifiedTheme(darkThemeOptions)
} */
