...
export const CreateComponent = () => {
  ...
  const [service, setService] = useState<ICreateService>({serviceId:"", name:"", active:true, description:"", security:"", rateLimiting: 0 });
  ...
  const handleClose = (reason: string) => {
    ...
    setService({serviceId:"", name:"", active:true, description:"", security:"", rateLimiting: 0 });
  };
  ...
  <Page themeId="tool">
    ...
    <AlertComponent open={show} close={handleClose} message="Service Registered!"/>
            ...
            <Grid container spacing={3} direction='column' justifyContent="center">
              ...
              <Grid item xs={12} >
                <Select
                  ...
                  displayEmpty         
                  onChange={(e)=>{
                    setService({...service, rateLimiting: e.target.value as number});
                  }}>
                    <MenuItem value=""><em>0</em></MenuItem>
                    <MenuItem value="none"><em>100</em></MenuItem>
              ...
              <Grid item xs={12} >
                <Select
                  ...
                  displayEmpty         
                  onChange={(e)=>{
                    setService({...service, security: e.target.value as string});
                  }}>
