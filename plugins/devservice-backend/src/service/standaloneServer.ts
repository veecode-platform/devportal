...
import { createServiceBuilder, loadBackendConfig, useHotMemoize } from '@backstage/backend-common';
...
export async function startStandaloneServer(
  ...
  const logger = options.logger.child({ service: 'devservice-backend' });
